...
# TensorFlow/Keras imports (modernized)
...
# frameRate = cap.get(0) #frame rate
# x=1
# while(cap.isOpened()):
...
# -----------------------------------------------------------------
# video_file = "test.mp4"  # Path to your video file.
#
...
# print ("Done!")
# -----------------------------------------------------------------
# After extracting the frames from the new video, we will now load the test.csv file which contains the
# names of each extracted frame.
# -----------------------------------------------------------------
